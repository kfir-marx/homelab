...
| Windows VM or RTX 3080 sharing | `terraform/deployments/prod/windows-workstation/config.yml` | `terraform/modules/stacks/windows-workstation/`, `terraform/modules/components/proxmox-windows-vm/` |
