...
const EN: Dict = {
  ...
  "newFlight.modal.subtitle": "Enter the itinerary and commercial details. The flight is saved to your live pipeline immediately.",
...
const HE: Dict = {
  ...
  "newFlight.modal.subtitle": "הזינו את פרטי המסלול והמסחר. הטיסה נשמרת מיד בצבר הפעיל שלכם.",
